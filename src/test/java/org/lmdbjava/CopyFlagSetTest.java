...
public class CopyFlagSetTest {
  ...
  public void testEmpty() {
    ...
    final CopyFlagSet copyFlagSet2 = CopyFlagSet.builder().build();
    assertThat(copyFlagSet).isEqualTo(copyFlagSet2);
    assertThat(copyFlagSet).isNotEqualTo(CopyFlagSet.of(CopyFlags.MDB_CP_COMPACT));
    assertThat(copyFlagSet)
        .isNotEqualTo(CopyFlagSet.builder().setFlag(CopyFlags.MDB_CP_COMPACT).build());
  }
  ...
  public void testOf() {
    ...
    final CopyFlagSet copyFlagSet2 = CopyFlagSet.builder().setFlag(copyFlag).build();
    assertThat(copyFlagSet).isEqualTo(copyFlagSet2);
  }
  ...
  public void testBuilder() {
    ...
    final CopyFlagSet copyFlagSet = CopyFlagSet.builder().setFlag(copyFlag1).build();
    ...
    final CopyFlagSet copyFlagSet2 = CopyFlagSet.builder().withFlags(copyFlag1).build();
    final CopyFlagSet copyFlagSet3 =
        CopyFlagSet.builder()
