...
public class TxnFlagSetTest {
  ...
  void testSingleEnum() {
    ...
    final TxnFlagSet txnFlagSet2 = TxnFlagSet.builder().setFlag(TxnFlags.MDB_RDONLY_TXN).build();
  ...
  public void testEmpty() {
    ...
    final TxnFlagSet txnFlagSet2 = TxnFlagSet.builder().build();
    assertThat(txnFlagSet).isEqualTo(txnFlagSet2);
    assertThat(txnFlagSet).isNotEqualTo(TxnFlagSet.of(TxnFlags.MDB_RDONLY_TXN));
    assertThat(txnFlagSet)
        .isNotEqualTo(TxnFlagSet.builder().setFlag(TxnFlags.MDB_RDONLY_TXN).build());
  }
  ...
  public void testOf() {
    ...
    final TxnFlagSet txnFlagSet2 = TxnFlagSet.builder().setFlag(txnFlag).build();
    assertThat(txnFlagSet).isEqualTo(txnFlagSet2);
  }
  ...
  public void testBuilder() {
    ...
    final TxnFlagSet txnFlagSet = TxnFlagSet.builder().setFlag(txnFlag1).build();
    ...
    final TxnFlagSet txnFlagSet2 = TxnFlagSet.builder().withFlags(txnFlag1).build();
    final TxnFlagSet txnFlagSet3 =
        TxnFlagSet.builder().withFlags(new HashSet<>(Collections.singletonList(txnFlag1))).build();
    assertThat(txnFlagSet).isEqualTo(txnFlagSet2);
